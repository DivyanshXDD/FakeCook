...
<body class="vh-100 vw-100">
    <section class="container d-flex justify-content-center align-items-center vh-100">
        <div class="mainFormDiv">
            <form class="d-flex flex-column" action="registerPostData.php" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <div class="form-group mb-3">
                        <label for="postAudience">Post Audience</label><br>
                        <input type="radio" id="kids" name="postAudience" value="kids">
                        <label for="html">For Kids</label><br>
                        <input type="radio" id="adults" name="postAudience" value="adults">
                        <label for="css">For Adults</label><br>
                    </div>
                </div>
                <div class="form-group mb-3">
